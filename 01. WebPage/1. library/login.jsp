	...
	try {
		...
		if (rs.next()) {
			if(rs.getString(1).equals(passwd)){
				response.sendRedirect("http://localhost:8080/MyJspPage/book.jsp?id="+request.getParameter("id"));
...
<p style="color:red"> 로그인에 실패하였습니다. 아이디와 비밀번호를 다시 확인해주세요. </p>
</div>
<hr>
